...
### SOP-002 (호두과자 전용반죽) 배합비 — 정확히 10 : 3 : 3 : 1
- RM001 계란: 17.65% (3/17)
- RM002 물: 17.65% (3/17 · 수도 공급 — 재고 추적 외, 품목 마스터에 행 자체가 없다)
- RM011 앙브레드호두과자 전용믹스: 58.82% (10/17 · 10kg 단위 정수 포대만) ⚠️2026-08 RM003 마미만쥬에서 교체
- RM006 콩기름(대두유): 5.88% (1/17)
- ⚠️ 시트에 **0.588 로 보이는 것은 셀 서식**이고 저장값은 `0.588235294117647` 이다 → 앱은 `SOP레시피` 를
  UNFORMATTED_VALUE 로 읽는다(안 그러면 표시 문자열이 잘려 들어온다).

### 생산 단위
- 봉당 5kg (포장 고정) · 반죽기 520L = **300kg 상한**
- 현장 표준: **40봉 / 200kg / 믹스 12포대** — 유효 WO 139건 중 131건(94%, 2026-04-17~09-08 실측)
- 화면 프리셋 3종: **51봉(255kg·15포대 = 폐기 0)** · 54봉 · 57봉 — 반죽기 안의 파레토 집합
- ⚠️ 12포대는 204kg(40.8봉)을 만든다 → 40봉 배치는 매번 **마지막 봉지 4kg 을 버린다**(9,247원, 그중 43%가 계란)
